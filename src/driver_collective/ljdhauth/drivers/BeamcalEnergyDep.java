...
public class BeamcalEnergyDep extends Driver {
    ...
    *******************************************************************************************/
	...
	System.out.println("Highest power drawn on a pixel was " + powerDraw(radDosage(maxPixelEnergy/numberOfEvents),runTemp) + "on layer " + layerOfMaxE);
	energyDepOverEvents += sumOfEnergy;
	System.out.println("Highest energy deposited on a pixel was " + maxPixelEnergy + "on layer " + layerOfMaxE);
	System.out.println("Radiation dosage for 3 years on this pixel is thus  " + radDosage(maxPixelEnergy));
